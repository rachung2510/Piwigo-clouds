...
{if isset($U_SLIDESHOW_STOP)}
    <a href="{$U_SLIDESHOW_STOP}" title="{'stop the slideshow'|@translate}" class="pwg-state-default pwg-button">
        <span class="pwg-icon pwg-icon-stop"></span><span class="pwg-button-text">{'stop the slideshow'|@translate}</span>
    </a>
{/if}
